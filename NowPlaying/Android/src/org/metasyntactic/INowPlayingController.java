...
public interface INowPlayingController extends android.os.IInterface {
  ...
  public static abstract class Stub extends android.os.Binder implements org.metasyntactic.INowPlayingController {
    ...
    /** Cast an IBinder object into an INowPlayingController interface, generating a proxy if needed. */
    public static org.metasyntactic.INowPlayingController asInterface(android.os.IBinder obj) {
      if ((obj == null)) {
        return null;
      }
      org.metasyntactic.INowPlayingController in = (org.metasyntactic.INowPlayingController) obj.queryLocalInterface(
          DESCRIPTOR);
      if ((in != null)) {
        return in;
      }
    ...
    static final int TRANSACTION_getScoreType = (IBinder.FIRST_CALL_TRANSACTION + 14);
    static final int TRANSACTION_setScoreType = (IBinder.FIRST_CALL_TRANSACTION + 15);
    static final int TRANSACTION_getScore = (IBinder.FIRST_CALL_TRANSACTION + 16);
    static final int TRANSACTION_getPoster = (IBinder.FIRST_CALL_TRANSACTION + 17);
    static final int TRANSACTION_getSynopsis = (IBinder.FIRST_CALL_TRANSACTION + 18);
