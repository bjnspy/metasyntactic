...
public class AllMoviesActivity extends Activity implements INowPlaying {
  ...
  private void setupView() {
    ...
    showtimes.setOnClickListener(new OnClickListener() {
      public void onClick(final View arg0) {
        ...
        final Intent intent = new Intent();
        intent
            .setClass(AllMoviesActivity.this, ShowtimesActivity.class);
        intent.putExtra("movie", (Parcelable) movie);
        startActivity(intent);
      }
    });
  ...
  private class DetailAdapter extends BaseAdapter {
    ...
    private class MovieViewHolder {
      ...
      private MovieViewHolder(Button score, TextView title, TextView rating, TextView length, TextView genre,
                              ImageView poster, TextView scoreLbl, TextView cast) {
        this.score = score;
        this.title = title;
        this.rating = rating;
        this.length = length;
