  ...
  protected void onListItemClick(final ListView l, final View v, final int position, final long id) {
    ...
    case LOCATION:
      ...
      dialog = new NowPlayingPreferenceDialog(SettingsActivity.this).setTitle(
          detailItems.get(position).getLabel()).setKey(detailItems.get(position).getKey())
    ...
    case SEARCH_DISTANCE:
      ...
      // are called
      // should not be changed.
      String[] distanceValues = SettingsActivity.this.getResources().getStringArray(
    ...
    case SEARCH_DATE:
      ...
      new DatePickerDialog(SettingsActivity.this, mDateSetListener, mYear, mMonth, mDay).show();
