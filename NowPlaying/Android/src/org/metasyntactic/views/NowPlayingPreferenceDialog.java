...
public class NowPlayingPreferenceDialog {
  ...
  public NowPlayingPreferenceDialog setItems(final String[] distanceValues) {
	final DialogInterface.OnClickListener listItemListener =
  ...
  private int getIntPreferenceValue() {
	...
	case AUTO_UPDATE_LOCATION:
	  return this.autoUpdate.indexOf(NowPlayingControllerWrapper
		  .isAutoUpdateEnabled());
  ...
  private void setIntPreferenceValue(final int prefValue) {
	...
	case REVIEWS_PROVIDER:
	  ...
	  break;
	case AUTO_UPDATE_LOCATION:
	  NowPlayingControllerWrapper.setAutoUpdateEnabled(this.autoUpdate
		  .get(prefValue));
	  break;
	}
  }
  ...
  //Work around to make handling of scoretype,auto_update same as sort preference, as both are choicetypes.
