...
public class FastScrollGridView extends FrameLayout implements OnScrollListener,
  ...
  public FastScrollGridView(Context context) {
    super(context);
    init(context);
  }
  ...
  public FastScrollGridView(Context context, AttributeSet attrs, int defStyle) {
  ...
  public void draw(Canvas canvas) {
    ...
    final FastScrollGridView.ScrollFade scrollFade = mScrollFade;
    int alpha = -1;
