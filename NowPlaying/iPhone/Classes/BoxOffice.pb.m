...
+ (PBFileDescriptor*) buildDescriptor {
  static uint8_t descriptorData[] = {
    10,15,66,111,120,79,102,102,105,99,101,46,112,114,111,116,111,34,77,10,
    13,83,104,111,119,116,105,109,101,80,114,111,116,111,18,12,10,4,84,105,
  ...
  NSData* data = [NSData dataWithBytes:descriptorData length:1233];
