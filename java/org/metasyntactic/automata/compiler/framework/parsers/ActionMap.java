...
public class ActionMap<T extends Token> {
  ...
  private final Map<String, Function4<Object, List<SourceToken<T>>, Integer, Integer, Object>> actions =
      new LinkedHashMap<String, Function4<Object, List<SourceToken<T>>, Integer, Integer, Object>>();
