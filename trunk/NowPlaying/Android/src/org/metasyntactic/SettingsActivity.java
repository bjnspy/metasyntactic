...
public class SettingsActivity extends ListActivity {
  ...
  private class TheaterAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, final ViewGroup viewGroup) {
      ...
      final Theater theater = SettingsActivity.this.theaters.get(theaterIndex);
      switch (SettingsActivity.this.detailItems.get(position).getType()) {
        case NAME_SHOWTIMES:
          holder.label.setTextAppearance(SettingsActivity.this, android.R.attr.textAppearanceLarge);
         ...
         holder.label.setTextColor(Color.WHITE);
          ...
          final List<Performance> list = NowPlayingControllerWrapper
              .getPerformancesForMovieAtTheater(SettingsActivity.this.movie, theater);
          holder.icon.setImageDrawable(SettingsActivity.this.getResources()
          ...
          if (list != null) {
            ...
            final Intent intent1 = new Intent(Intent.ACTION_SENDTO, Uri
                .parse("mailto:" + addr));
            intent1.putExtra("subject", "ShowTimes for " + SettingsActivity.this.movie
                .getDisplayTitle() + " at " + theater.getName());
            intent1.putExtra("body", performance);
            SettingsActivity.this.detailItems.get(position).setIntent(intent1);
          } else {
        ...
        case PHONE:
          ...
          SettingsActivity.this.detailItems.get(position).setIntent(intent2);
          break;
        case ADDRESS:
          ...
          SettingsActivity.this.detailItems.get(position).setIntent(intent3);
      }
      return convertView;
    }
