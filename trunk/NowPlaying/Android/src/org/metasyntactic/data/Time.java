...
public class Time implements Parcelable, Persistable, Comparable<Time> {
  ...
  public static final Reader<Time> reader = new AbstractPersistable.AbstractReader<Time>() {
  ...
  public String toString() {
    if (timeString == null) {
      timeString = String.valueOf(hour) + ':' + String.valueOf(minute) + (am ? "am" : "pm");
    }
