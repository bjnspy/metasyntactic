...
public class ShowtimesDetailsActivity extends ListActivity {
  ...
  public void onCreate(final Bundle savedInstanceState) {
    ...
    this.performances = NowPlayingControllerWrapper.getPerformancesForMovieAtTheater(this.movie, this.theater);
      ...
      switch (ShowtimesDetailsActivity.this.detailItems.get(position).getType()) {
        case NAME_SHOWTIMES:
          holder.label.setText(
              res.getString(R.string.showtimes_for) + ' ' + ShowtimesDetailsActivity.this.movie.getDisplayTitle());
          ...
          intent1.putExtra("subject", res.getString(
              R.string.showtimes_for) + ' ' + ShowtimesDetailsActivity.this.theater.getName());
        ...
        case PHONE:
          ...
          final Intent intent2 = new Intent("android.intent.action.DIAL",
                                            Uri.parse("tel:" + ShowtimesDetailsActivity.this.theater.getPhoneNumber()));
    ...
    return new AlertDialog.Builder(this).setTitle(R.string.order_tickets).setItems(criteria,
                                                                                   new DialogInterface.OnClickListener() {
                                                                                     public void onClick(
                                                                                         ...
                                                                                         final int which) {
                                                                                       final String order_url = ShowtimesDetailsActivity.this.showtimes_url.get(
                                                                                           which);
