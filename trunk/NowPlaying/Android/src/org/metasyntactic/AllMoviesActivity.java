...
public class AllMoviesActivity extends Activity implements INowPlaying {
  ...
  private void setupView() {
    ...
    OnItemClickListener thumblistener = new OnItemClickListener() {
      public void onItemClick(AdapterView<?> arg0, View arg1, int position, long id) {
        ...
        Animation animation = AnimationUtils.loadAnimation(mContext, R.anim.fade_gallery_item);
        arg1.setAnimation(animation);
      }
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    if (item.getItemId() == MENU_SORT) {
      NowPlayingPreferenceDialog builder = new NowPlayingPreferenceDialog((AllMoviesActivity) mContext).setTitle(
