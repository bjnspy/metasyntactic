...
/**
 * This class is used internally by the Protocol Buffer library and generated message implementations.  It is public
 * only because those generated messages do not reside in the {@code protocol2} package.  Others should not use this
 * class directly.
 * <p/>
...
public final class WireFormat {
  ...
  static int getWireFormatForFieldType(final Descriptors.FieldDescriptor.Type type) {
    switch (type) {
      case DOUBLE:
