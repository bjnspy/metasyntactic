...
@protocol BoxOfficeSharedApplicationDelegate;
...
@class AmazonCache;
@class AppleMoviePosterDownloader;
@class Application;
@class BlurayCache;
@class MovieCacheUpdater;
...
@class FandangoMoviePosterDownloader;
@class FavoriteTheater;
@class HelpCache;
@class IMDbCache;
@class ImdbMoviePosterDownloader;
@class InternationalDataCache;
@class LargeMoviePosterCache;
...
@class PreviewNetworksMoviePosterDownloader;
@class Review;
...
@class WikipediaApiPersonPosterDownloader;
@class WikipediaScrapePersonPosterDownloader;
