...
@class PBExtensionRegistry_ExtensionInfo;
@class PBExtensionRegistry_DescriptorIntPair;
@class PBField;
...
@class SingularMessageFieldAccessor;
@class SingularEnumFieldAccessor;
@class SingularFieldAccessor;
