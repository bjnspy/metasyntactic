...
// CodeGenerator implementation which generates ObjectiveC code.  If you create your
// own protocol compiler binary and you want it to support ObjectiveC output, you
