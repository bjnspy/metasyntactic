...
@private
  ...
  BOOL hasRawRating_:1;
  BOOL hasImdbUrl_:1;
  BOOL hasReleaseDate_:1;
  int32_t length;
  int32_t score;
  NSString* identifier;
  NSString* title;
...
@private
  ...
  BOOL hasIdentifier_:1;
  BOOL hasName_:1;
  BOOL hasStreetAddress_:1;
  BOOL hasCity_:1;
  BOOL hasState_:1;
  BOOL hasPostalCode_:1;
  BOOL hasCountry_:1;
  BOOL hasPhone_:1;
  Float64 latitude;
  Float64 longitude;
...
@private
  BOOL hasMovieIdentifier_:1;
  BOOL hasShowtimes_:1;
