...
public class Leaf extends AbstractNode {
    ...
    char result1, nextLeafGeneration;
    ...
    public boolean touchesEdge() {
        ...
        return super.touchesEdge();
    }

    public boolean touchesNorthEdge() {
        return touchesNorth(northEast) ||
                touchesNorth(northWest);
    }

    public boolean touchesSouthEdge() {
        return touchesSouth(southEast) ||
                touchesSouth(southWest);
    }

    public boolean touchesEastEdge() {
        return touchesEast(northEast) ||
                touchesEast(southEast);
    }

    public boolean touchesWestEdge() {
        return touchesWest(northWest) ||
                touchesWest(southWest);
    }

    private boolean touchesNorth(short quadrant) {
        return (quadrant & 0xf000) != 0;
    }

    private boolean touchesEast(short quadrant) {
        return (quadrant & 0x1111) != 0;
    }

    private boolean touchesWest(short quadrant) {
        return (quadrant & 0x8888) != 0;
    }

    private boolean touchesSouth(short quadrant) {
        return (quadrant & 0x000f) != 0;
    }
    */
    ...
    public static Leaf newLeaf(int northWest, int northEast, int southWest, int southEast) {
        ...
        Leaf result = (Leaf) internMap.get(leaf);
        if (result == null) {
            result = leaf;
    ...
    private final static AbstractNode empty = newLeaf(0, 0, 0, 0);

    public static AbstractNode emptyLeaf() {
        return empty;
    }
