...
public class Node extends AbstractNode {
    ...
    /*
    public boolean touchesNorthEdge() {
        return northEast.touchesNorthEdge() || northWest.touchesNorthEdge();
    }

    public boolean touchesSouthEdge() {
        return southEast.touchesSouthEdge() || southWest.touchesSouthEdge();
    }

    public boolean touchesEastEdge() {
        return northEast.touchesEastEdge() || southEast.touchesEastEdge();
    }

    public boolean touchesWestEdge() {
        return northWest.touchesWestEdge() || southWest.touchesWestEdge();
    }
    */
    ...
    protected AbstractNode nextGenerationWorker() {
        //*
        if (northWest instanceof Node) {
            return nextNodeGeneration1();
        } else {
            return nextLeafGeneration1();
        }
        /*/
        if (northWest instanceof Node) {
    ...
    private Leaf nextLeafGeneration1() {
        /*
        Leaf nw = (Leaf) northWest, ne = (Leaf) northEast,
                sw = (Leaf) southWest, se = (Leaf) southEast;

        char t00 = nw.nextLeafGeneration;
        char t01 = Leaf.newLeaf(nw.northEast, ne.northWest, nw.southEast, ne.southWest).nextLeafGeneration;
        char t02 = ne.nextLeafGeneration;
        char t10 = Leaf.newLeaf(nw.southWest, nw.southEast, sw.northWest, sw.northEast).nextLeafGeneration;
        char t11 = Leaf.newLeaf(nw.southEast, ne.southWest, sw.northEast, se.northWest).nextLeafGeneration;
        char t12 = Leaf.newLeaf(ne.southWest, ne.southEast, se.northWest, se.northEast).nextLeafGeneration;
        char t20 = sw.nextLeafGeneration;
        char t21 = Leaf.newLeaf(sw.northEast, se.northWest, sw.southEast, se.southWest).nextLeafGeneration;
        char t22 = se.nextLeafGeneration;
    ...
    private AbstractNode nextNodeGeneration1() {
        Node nw = (Node) northWest, ne = (Node) northEast,
                sw = (Node) southWest, se = (Node) southEast;
    ...
    private Node nextNodeGeneration() {
        Node nw = (Node) northWest, ne = (Node) northEast,
                sw = (Node) southWest, se = (Node) southEast;
        ...
        return Node.newNode(
                Node.newNode(t00, t01, t10, t11).nextGeneration(),
                Node.newNode(t01, t02, t11, t12).nextGeneration(),
                Node.newNode(t10, t11, t20, t21).nextGeneration(),
                Node.newNode(t11, t12, t21, t22).nextGeneration());
    }
    ...
    private Leaf nextLeafGeneration() {
        ...
        return Leaf.newLeaf(
                Leaf.newLeaf(t00, t01, t10, t11).nextLeafGeneration,
                Leaf.newLeaf(t01, t02, t11, t12).nextLeafGeneration,
                Leaf.newLeaf(t10, t11, t20, t21).nextLeafGeneration,
                Leaf.newLeaf(t11, t12, t21, t22).nextLeafGeneration);
    }
