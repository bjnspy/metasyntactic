...
@property (assign) id<TappableViewDelegate> tapDelegate;
@property (assign) id<TouchableViewDelegate> touchDelegate;
@property (assign) id<PinchableViewDelegate> pinchDelegate;
