...
- (void) moveBackward:(UITableView*) previousTableView {
  [self moveTo:previousTableView withTransition:UIViewAnimationTransitionFlipFromLeft];
}


- (void) moveForward:(UITableView*) nextTableView {
  [self moveTo:nextTableView withTransition:UIViewAnimationTransitionFlipFromRight];
}
