...
#define HORIZONTAL_SWIPE_HORIZONTAL_DRAG_MIN    12
#define HORIZONTAL_SWIPE_VERTICAL_DRAG_MAX      4

#define VERTICAL_SWIPE_VERTICAL_DRAG_MIN        12
#define VERTICAL_SWIPE_HORIZONTAL_DRAG_MAX      4
...
- (void) handleTouch:(NSSet*) touches {
    ...
    if (ABS(startSwipePosition.x - currentTouchPosition.x) >= HORIZONTAL_SWIPE_HORIZONTAL_DRAG_MIN &&
        ABS(startSwipePosition.y - currentTouchPosition.y) <= HORIZONTAL_SWIPE_VERTICAL_DRAG_MAX) {
    ...
    } else if (ABS(startSwipePosition.x - currentTouchPosition.x) <= VERTICAL_SWIPE_HORIZONTAL_DRAG_MAX &&
               ABS(startSwipePosition.y - currentTouchPosition.y) >= VERTICAL_SWIPE_VERTICAL_DRAG_MIN) {
